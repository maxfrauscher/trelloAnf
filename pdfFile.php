...
$title = 'Anforderungsprofil Analytics';
...
$tA = $_POST["trackingArt"];
$trig = $_POST["trigger"];
$zB = $_POST["zielBeschreibung"];
...
$html .= '</td></tr></table>
<h3>Google Analytics Informationen</h3>
<table cellpadding="5" cellspacing="0" style="width: 100%;"  border="1">
<tr><td>
<b>Tracking-Art: </b>'.$tA.'<br>
<b>Trigger: </b>'.$trig.'<br>
<b>Zielbeschreibung: </b>' . $zB . '</td></tr></table>';
...
EOT;
    ...
    public function Footer() {
        ...
        $this->Cell($w=0, $h=0, $this->getAliasNumPage().'/'.$this->getAliasNbPages(), $border=0, $ln=0, $align='L', $fill=0, $link='', $stretch=0, $ignore_min_height=false, $calign='M', $valign='R');
